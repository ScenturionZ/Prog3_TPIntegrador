...
const { findCarreraById, findAllCarreras, deleteCarrera, activeCarrera, createCarrera, updateCarrera, findMateriasAsociadas, findEstudiantesIncriptos } = require("../../controllers/carrera");

router.post("/carreras", createCarrera);
router.get("/carreras/incriptos", findEstudiantesIncriptos);
